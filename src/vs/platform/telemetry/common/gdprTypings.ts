...
export type StrictPropertyChecker<TEvent, TClassifiedEvent, TError> =
...
export type StrictPropertyCheck<
  ...
  E
> = StrictPropertyChecker<E, ClassifiedEvent<T>, StrictPropertyCheckError>;

export type GDPRClassification<T> = {
