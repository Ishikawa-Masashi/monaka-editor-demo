...
> extends ResolvedKeybinding {
  ...
  public getAriaLabel(): string | null {
    return AriaLabelProvider.toLabel(this._os, this._parts, (keybinding) =>
  ...
  public getSingleModifierDispatchParts(): (string | null)[] {
    return this._parts.map((keybinding) =>
      this._getSingleModifierDispatchPart(keybinding)
    );
  }
  ...
  protected abstract _getSingleModifierDispatchPart(
    keybinding: T
  ): string | null;
}
