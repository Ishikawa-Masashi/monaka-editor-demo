...
export type ExtensionUntrustedWorkpaceSupportType =
  | boolean
  | LimitedWorkpaceSupportType;
export type ExtensionUntrustedWorkspaceSupport =
  | { supported: true }
  | { supported: false; description: string }
  | {
      supported: LimitedWorkpaceSupportType;
      description: string;
      restrictedConfigurations?: string[];
    };

export type ExtensionVirtualWorkpaceSupportType =
  | boolean
  | LimitedWorkpaceSupportType;
export type ExtensionVirtualWorkpaceSupport =
  | boolean
  | { supported: true }
  | { supported: false | LimitedWorkpaceSupportType; description: string };

export function getWorkpaceSupportTypeMessage(
  supportType:
    | ExtensionUntrustedWorkspaceSupport
    | ExtensionVirtualWorkpaceSupport
    | undefined
): string | undefined {
...
export function isAuthenticaionProviderExtension(
