...
export namespace ThemeColor {
  export function isThemeColor(obj: any): obj is ThemeColor {
    return (
      obj && typeof obj === 'object' && typeof (<ThemeColor>obj).id === 'string'
    );
  }
}
...
export namespace ThemeIcon {
  ...
  export const asClassNameArray: (icon: ThemeIcon) => string[] =
    CSSIcon.asClassNameArray;
  export const asClassName: (icon: ThemeIcon) => string = CSSIcon.asClassName;
  export const asCSSSelector: (icon: ThemeIcon) => string =
    CSSIcon.asCSSSelector;
}
