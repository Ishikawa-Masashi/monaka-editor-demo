...
import {
  IJSONSchema,
  IJSONSchemaMap,
} from '../../../../vs/base/common/jsonSchema';
...
class ColorRegistry implements IColorRegistry {
  ...
  private colorSchema: IJSONSchema & { properties: IJSONSchemaMap } = {
    type: 'object',
    properties: {},
  };
  ...
  public registerColor(
    ...
    let colorContribution: ColorContribution = {
      id,
      description,
      defaults,
      needsTransparency,
...
export const editorWarningForeground = registerColor(
  ...
  { dark: '#CCA700', light: '#BF8803', hc: null },
  nls.localize(
    'editorWarning.foreground',
...
export const listActiveSelectionBackground = registerColor(
  ...
  { dark: '#094771', light: '#0060C0', hc: null },
  nls.localize(
...
export const listHighlightForeground = registerColor(
  ...
  { dark: '#18A3FF', light: '#0066BF', hc: focusBorder },
  nls.localize(
    'highlight',
...
export const tableColumnsBorder = registerColor(
  ...
  { dark: '#CCCCCC20', light: '#61616120', hc: null },
  nls.localize(
    'treeIndentGuidesStroke',
    'Tree stroke color for the indentation guides.'
  )
...
let schemaRegistry = platform.Registry.as<IJSONContributionRegistry>(
