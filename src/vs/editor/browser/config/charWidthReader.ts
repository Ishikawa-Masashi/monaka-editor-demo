...
class DomCharWidthReader {
  ...
  private _createDomElements(): void {
    ...
    regularDomNode.style.fontFamily =
      this._bareFontInfo.getMassagedFontFamily();
    regularDomNode.style.fontWeight = this._bareFontInfo.fontWeight;
    regularDomNode.style.fontSize = this._bareFontInfo.fontSize + 'px';
    regularDomNode.style.fontFeatureSettings =
      this._bareFontInfo.fontFeatureSettings;
    ...
    boldDomNode.style.fontFeatureSettings =
      this._bareFontInfo.fontFeatureSettings;
    ...
    italicDomNode.style.fontFeatureSettings =
      this._bareFontInfo.fontFeatureSettings;
