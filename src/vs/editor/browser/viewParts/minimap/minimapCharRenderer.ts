...
export class MinimapCharRenderer {
  ...
  public renderChar(
    ...
    // 後で必ず修正すること
    const backgroundR = backgroundColor ? backgroundColor.r : 0;
    const backgroundG = backgroundColor ? backgroundColor.g : 0;
    const backgroundB = backgroundColor ? backgroundColor.b : 0;
    ...
    // 後で必ず修正すること
    const deltaR = (color ? color.r : 0) - backgroundR;
    const deltaG = (color ? color.g : 0) - backgroundG;
    const deltaB = (color ? color.b : 0) - backgroundB;
