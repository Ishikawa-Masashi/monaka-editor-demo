  ...
  implements IVisibleLinesHost<ViewLine>, IViewLines
{
  ...
  public createVisibleLine(): ViewLine {
    return new ViewLine(this._viewLineOptions, this.editorId);
  }
  ...
  public linesVisibleRangesForRange(
    ...
    const domNode = document.getElementById(`${this.editorId}-view-lines`);
  ...
  private _visibleRangesForLineRange(
    ...
    return this._visibleLines
      ...
      .getVisibleRangesForRange(
        ...
        new DomReadingContext(domNode, this._textRangeRestingSpot)
      );
  }
