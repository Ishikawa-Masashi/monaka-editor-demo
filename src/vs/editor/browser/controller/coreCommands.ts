...
export namespace CoreNavigationCommands {
  ...
  export const ColumnSelect: CoreEditorCommand = registerEditorCommand(
    new (class extends ColumnSelectCommand {
      ...
      protected _getColumnSelectResult(
        ...
        let fromViewLineNumber = args.doColumnSelect
  ...
  export const CursorColumnSelectLeft: CoreEditorCommand =
    registerEditorCommand(
      new (class extends ColumnSelectCommand {
        constructor() {
          super({
  ...
  export const CursorColumnSelectPageUp: CoreEditorCommand =
    registerEditorCommand(
      new ColumnSelectUpCommand({
        isPaged: true,
  ...
  export const CursorColumnSelectDown: CoreEditorCommand =
    registerEditorCommand(
      new ColumnSelectDownCommand({
        ...
        kbOpts: {
          ...
          kbExpr: EditorContextKeys.textInputFocus,
          primary:
            KeyMod.CtrlCmd | KeyMod.Shift | KeyMod.Alt | KeyCode.DownArrow,
          linux: { primary: 0 },
        },
      })
    );

  export const CursorColumnSelectPageDown: CoreEditorCommand =
    registerEditorCommand(
      new ColumnSelectDownCommand({
        isPaged: true,
        ...
        kbOpts: {
          ...
          kbExpr: EditorContextKeys.textInputFocus,
          primary:
            KeyMod.CtrlCmd | KeyMod.Shift | KeyMod.Alt | KeyCode.PageDown,
          linux: { primary: 0 },
        },
      })
    );
  ...
  export const LastCursorMoveToSelect: CoreEditorCommand =
    registerEditorCommand(
      new (class extends CoreEditorCommand {
        constructor() {
          super({
    ...
    private _exec(cursors: CursorState[]): PartialCursorState[] {
      ...
      for (let i = 0, len = cursors.length; i < len; i++) {
        ...
        result[i] = CursorState.fromModelState(
          cursor.modelState.move(this._inSelectionMode, lineNumber, 1, 0)
        );
      }
      return result;
    }
  ...
  export const CursorLineStartSelect: CoreEditorCommand = registerEditorCommand(
    new LineStartCommand({
      inSelectionMode: true,
  ...
  export const CursorLineEndSelect: CoreEditorCommand = registerEditorCommand(
    new LineEndCommand({
      inSelectionMode: true,
  ...
  export class EditorScrollImpl extends CoreEditorCommand {
    ...
    _runEditorScroll(
      ...
      if (args.revealCursor) {
        ...
        const desiredVisibleViewRange =
          viewModel.getCompletelyVisibleViewRangeAtScrollTop(desiredScrollTop);
    ...
    private _computeDesiredScrollTop(
      ...
      if (args.unit === EditorScroll_.Unit.Line) {
        ...
        return viewModel.getVerticalOffsetForLineNumber(
      ...
      if (args.unit === EditorScroll_.Unit.Page) {
        ...
        noOfLines =
          Math.round(viewModel.cursorConfig.pageSize / 2) * args.value;
      } else {
  ...
  export const LastCursorLineSelectDrag: CoreEditorCommand =
    registerEditorCommand(
      new LastCursorLineCommand({
        inSelectionMode: true,
  ...
  export const RemoveSecondaryCursors: CoreEditorCommand =
    registerEditorCommand(
      new (class extends CoreEditorCommand {
        constructor() {
          super({
  ...
  export const RevealLine: CoreEditorCommand = registerEditorCommand(
    new (class extends CoreEditorCommand {
      ...
      public runCoreEditorCommand(viewModel: IViewModel, args: any): void {
        ...
        const viewRange =
          viewModel.coordinatesConverter.convertModelRangeToViewRange(range);
  ...
  export const SetSelection: CoreEditorCommand = registerEditorCommand(
    new (class extends CoreEditorCommand {
      constructor() {
        super({
          id: 'setSelection',
