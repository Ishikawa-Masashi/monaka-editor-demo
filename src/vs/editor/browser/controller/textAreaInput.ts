...
export class TextAreaInput extends Disposable {
  ...
  constructor(
            ...
            if (isArrowKey || browser.isFirefox) {
              ...
              this._textAreaState = new TextAreaState(
                ...
                this._textAreaState.selectionStartPosition
                  ? new Position(
                      this._textAreaState.selectionStartPosition.lineNumber,
    ...
    const deduceAndroidCompositionInput = (): [TextAreaState, ITypeData] => {
      ...
      return [
        newState,
        TextAreaState.deduceAndroidCompositionInput(oldState, newState),
      ];
    };
      ...
      dom.addDisposableListener(
        ...
        (e: ClipboardEvent) => {
          ...
          if (ClipboardEventUtils.canUseTextData(e)) {
            const [pastePlainText, metadata] =
              ClipboardEventUtils.getTextData(e);
            if (pastePlainText !== '') {
  ...
  private _ensureClipboardGetsEditorSelection(e: ClipboardEvent): void {
    const dataToCopy = this._host.getDataToCopy(
      ClipboardEventUtils.canUseTextData(e)
    );
...
class TextAreaWrapper extends Disposable implements ITextAreaWrapper {
  ...
  public getSelectionStart(): number {
    return this._actual.domNode.selectionDirection === 'backward'
      ? this._actual.domNode.selectionEnd
      : this._actual.domNode.selectionStart;
  }
