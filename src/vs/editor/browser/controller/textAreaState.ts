  ...
  public static deduceInput(
    ...
    if (currentSelectionStart === currentSelectionEnd) {
      ...
      if (_debugComposition) {
        console.log(
          'REMOVE PREVIOUS: ' +
            (previousPrefix.length - prefixLength) +
            ' chars'
        );
      }
...
export class PagedScreenReaderStrategy {
  ...
  public static fromEditorSelection(
    ...
    const pretextRange = selectionStartPageRange.intersectRanges(
    ...
    const posttextRange = selectionEndPageRange.intersectRanges(
      new Range(
        selection.endLineNumber,
        selection.endColumn,
        lastLine,
    ...
    return new TextAreaState(
      ...
      new Position(selection.endLineNumber, selection.endColumn)
    );
  }
}
