...
function isWorkspaceFileEdit(thing: any): thing is WorkspaceFileEdit {
  return (
    isObject(thing) &&
    (Boolean((<WorkspaceFileEdit>thing).newUri) ||
      Boolean((<WorkspaceFileEdit>thing).oldUri))
  );
}
...
function isWorkspaceTextEdit(thing: any): thing is WorkspaceTextEdit {
  return (
    isObject(thing) &&
    URI.isUri((<WorkspaceTextEdit>thing).resource) &&
    isObject((<WorkspaceTextEdit>thing).edit)
  );
}
