...
export function getDocumentSemanticTokens(
...
): IDocumentSemanticTokensResult | null {
  ...
  return {
    ...
    request: Promise.resolve(
      provider.provideDocumentSemanticTokens(model, lastResultId, token)
    ),
  };
}

function _getDocumentSemanticTokensProvider(
  model: ITextModel
...
export function getDocumentRangeSemanticTokensProvider(
  model: ITextModel
): DocumentRangeSemanticTokensProvider | null {
