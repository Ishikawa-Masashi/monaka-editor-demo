...
export namespace AccessibilityHelpNLS {
  ...
  export const singleSelectionRange = nls.localize(
    'singleSelectionRange',
    'Line {0}, Column {1} ({2} selected)'
  );
  export const singleSelection = nls.localize(
    'singleSelection',
    'Line {0}, Column {1}'
  );
  export const multiSelectionRange = nls.localize(
    'multiSelectionRange',
    '{0} selections ({1} characters selected)'
  );
  export const multiSelection = nls.localize(
    'multiSelection',
    '{0} selections'
  );
  export const emergencyConfOn = nls.localize(
    'emergencyConfOn',
  ...
  export const tabFocusModeOnMsgNoKb = nls.localize(
