...
export class ViewportData {
  ...
  public convertViewPositionToModelPosition(
    ...
    return this._model.coordinatesConverter.convertViewPositionToModelPosition(
      new Position(viewLineNumber, viewColumn)
    );
  }
  public convertModelPositionToViewPosition(
    ...
    return this._model.coordinatesConverter.convertModelPositionToViewPosition(
      new Position(modelLineNumber, modelColumn)
    );
  }
}
