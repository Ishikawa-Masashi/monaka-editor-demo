...
export class ViewModelDecorations implements IDisposable {
  ...
  constructor(
    ...
    linesCollection: IViewModelLinesCollection,
  ...
  private _getOrCreateViewModelDecoration(
    ...
    if (!r) {
      ...
      if (options.isWholeLine) {
        ...
        viewRange =
          this._coordinatesConverter.convertModelRangeToViewRange(modelRange);
      }
  ...
  public getDecorationsViewportData(
    ...
    if (!cacheIsValid) {
      this._cachedModelDecorationsResolver =
        this._getDecorationsViewportData(viewRange);
