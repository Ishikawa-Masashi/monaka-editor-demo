...
export module StaticServices {
  ...
  function define<T>(
    serviceId: ServiceIdentifier<T>,
    factory: (overrides: IEditorOverrideServices | undefined) => T
  ): LazyStaticService<T> {
  ...
  export const resourceConfigurationService = define(
    ITextResourceConfigurationService,
    () => new SimpleResourceConfigurationService(configurationServiceImpl)
  );

  export const resourcePropertiesService = define(
    ITextResourcePropertiesService,
    () => new SimpleResourcePropertiesService(configurationServiceImpl)
  );

  export const contextService = define(
    IWorkspaceContextService,
    () => new SimpleWorkspaceContextService()
  );

  export const labelService = define(
    ILabelService,
    () => new SimpleUriLabelService()
  );
  ...
  export const dialogService = define(
    IDialogService,
    () => new SimpleDialogService()
  );

  export const notificationService = define(
  ...
  export const logService = define(
    ILogService,
    () => new LogService(new ConsoleLogger())
  );

  export const undoRedoService = define(
    IUndoRedoService,
    (o) => new UndoRedoService(dialogService.get(o), notificationService.get(o))
  );
  ...
  export const markerDecorationsService = define(
    IMarkerDecorationsService,
    (o) =>
      new MarkerDecorationsService(modelService.get(o), markerService.get(o))
  );

  export const contextKeyService = define(
    IContextKeyService,
    (o) => new ContextKeyService(configurationService.get(o))
  );

  export const codeEditorService = define(
    ICodeEditorService,
    (o) =>
      new StandaloneCodeEditorServiceImpl(
        null,
        contextKeyService.get(o),
        standaloneThemeService.get(o)
      )
  );

  export const editorProgressService = define(
  ...
  export const editorWorkerService = define(
    ...
    (o) =>
      new EditorWorkerServiceImpl(
        modelService.get(o),
        resourceConfigurationService.get(o),
        logService.get(o)
      )
  );
}
...
export class DynamicStandaloneServices extends Disposable {
  ...
  constructor(domElement: HTMLElement, overrides: IEditorOverrideServices) {
    ...
    let ensure = <T>(serviceId: ServiceIdentifier<T>, factory: () => T): T => {
      ...
      () => new AccessibilityService(contextKeyService, configurationService)
    );
    ...
    let layoutService = ensure(
      ILayoutService,
      () =>
        new SimpleLayoutService(
    ...
    let contextViewService = ensure(IContextViewService, () =>
      this._register(new ContextViewService(layoutService))
    );
      ...
      IBulkEditService,
      () =>
        new SimpleBulkEditService(
          StaticServices.modelService.get(IModelService)
        )
    );
  }
