  ...
  implements IStandaloneCodeEditor
{
  ...
  constructor(
    ...
    options.ariaLabel =
      options.ariaLabel || StandaloneCodeEditorNLS.editorViewAccessibleLabel;
    options.ariaLabel =
      options.ariaLabel +
      ';' +
  ...
  implements IStandaloneCodeEditor
{
  ...
  constructor(
    ...
    const themeDomRegistration = (<StandaloneThemeServiceImpl>(
      themeService
