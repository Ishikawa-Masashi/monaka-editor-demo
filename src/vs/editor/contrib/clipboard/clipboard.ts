...
MenuRegistry.appendMenuItem(MenuId.MenubarEditMenu, {
  ...
  title: { value: nls.localize('copy as', 'Copy As'), original: 'Copy As' },
  group: '2_ccp',
  order: 3,
});
      ...
      if (focusedEditor && focusedEditor.hasTextFocus()) {
        ...
        if (!result && platform.isWeb) {
          (async () => {
            ...
            if (clipboardText !== '') {
              const metadata =
                InMemoryClipboardMetadataManager.INSTANCE.get(clipboardText);
              ...
              if (metadata) {
                ...
                multicursorText =
                  typeof metadata.multicursorText !== 'undefined'
