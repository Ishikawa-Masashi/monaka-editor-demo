...
import {
  FoldingRegions,
  ILineRange,
} from '../../../../vs/editor/contrib/folding/foldingRanges';
import { RangeProvider } from './folding';
import { CancellationToken } from '../../../../vs/base/common/cancellation';
import {
  IFoldingRangeData,
  sanitizeRanges,
} from '../../../../vs/editor/contrib/folding/syntaxRangeProvider';
...
export class InitializingRangeProvider implements RangeProvider {
  ...
  constructor(
    ...
    if (initialRanges.length) {
      ...
      this.decorationIds = editorModel.deltaDecorations(
        [],
        initialRanges.map(toDecorationRange)
      );
