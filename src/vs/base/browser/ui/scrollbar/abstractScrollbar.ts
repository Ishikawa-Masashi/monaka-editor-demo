...
export abstract class AbstractScrollbar extends Widget {
  ...
  private _onMouseDown(e: IMouseEvent): void {
    ...
    if (
      ...
      typeof e.browserEvent.offsetX === 'number' &&
      typeof e.browserEvent.offsetY === 'number'
    ) {
  ...
  private _sliderMouseDown(e: IMouseEvent, onDragFinished: () => void): void {
    ...
    const initialMouseOrthogonalPosition =
      this._sliderOrthogonalMousePosition(e);
    ...
    this._mouseMoveMonitor.startMonitoring(
      ...
      (mouseMoveData: IStandardMouseMoveEventData) => {
        const mouseOrthogonalPosition =
          this._sliderOrthogonalMousePosition(mouseMoveData);
