...
export class Storage extends Disposable implements IStorage {
  ...
  private readonly flushDelayer = new ThrottledDelayer<void>(
    Storage.DEFAULT_FLUSH_DELAY
  );
  ...
  constructor(
    protected readonly database: IStorageDatabase // private readonly options: IStorageOptions = Object.create(null)
  ) {
    super();
